...
namespace Employee.MVC.SeviceProxies
{
    public class EmployeeServiceProxy
    {
        ...
        public async Task<Employee.MVC.Models.Employee> GetEmployeeById(int id)
        {
            Employee.MVC.Models.Employee EmpInfo = new Employee.MVC.Models.Employee();
            ...
            using (var client = new HttpClient())
            {
                ...
                if (Res.IsSuccessStatusCode)
                {
                    ...
                    //Deserializing the response recieved from web api and storing into the Employee list  
                    EmpInfo = JsonConvert.DeserializeObject<Employee.MVC.Models.Employee>(EmpResponse);
        ...
        public async Task<Employee.MVC.Models.Employee> Create(Employee.MVC.Models.Employee newEmployee)
        {
            Employee.MVC.Models.Employee EmpInfo = new Employee.MVC.Models.Employee();
